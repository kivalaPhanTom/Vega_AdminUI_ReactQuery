...
const statusSlice = createSlice({
      ...
      reducers: {
            ...
            handleAlertAddResultAction: (state, action) => {
                  ...
                  switch (signal) {
                        case RESULT_STATUS.SUCCESS:
                              MessageCommon.openNotificationSuccess('Tạo trạng thái thành công')
                              break;
                        case RESULT_STATUS.ERROR:
                              MessageCommon.openNotificationError('Tạo trạng thái thất bại')
                              break;
                        case RESULT_STATUS.DATA_EXIST:
            ...
            handleAlertEditResultAction: (state, action) => {
                  ...
                  switch (signal) {
                        case RESULT_STATUS.SUCCESS:
                              MessageCommon.openNotificationSuccess('sửa trạng thái thành công')
                              break;
                        case RESULT_STATUS.ERROR:
                              MessageCommon.openNotificationError('Sửa trạng thái thất bại')
                              break;
                        default:
                              MessageCommon.openNotificationError('Sửa trạng thái thất bại')
                              break;
            ...
            handleAlertDeleteResultAction: (state, action) => {
                  ...
                  switch (signal) {
                        case RESULT_STATUS.SUCCESS:
                              MessageCommon.openNotificationSuccess('Xóa trạng thái thành công')
                              break;
                        case RESULT_STATUS.ERROR:
                              MessageCommon.openNotificationError('Xóa trạng thái thất bại')
                              break;
                        default:
                              MessageCommon.openNotificationError('Xóa trạng thái thất bại')
                              break;
...
export const {setModalAdd,handleAlertAddResultAction, updateDataEdit, setConfirmEdit, handleAlertEditResultAction, setConfirmDelete, handleAlertDeleteResultAction } = statusSlice.actions
